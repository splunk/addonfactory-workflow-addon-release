...
class WorkflowStructureTests(unittest.TestCase):
    ...
    def test_ta_validator_pr_exception_preflight_precedes_full_evaluation(self):
        ...
        action_sha = "9e9dc782cdd784515490000754976e2317a931a3"
    ...
    def test_full_evaluation_consumes_only_validated_exception_input(self):
        ...
        self.assertIn(
            "run-ta-validator@9e9dc782cdd784515490000754976e2317a931a3",
            run_scorecard,
        )
        self.assertEqual(
            run_scorecard.count("run-ta-validator@9e9dc782cdd784515490000754976e2317a931a3"),
            1,
        )
